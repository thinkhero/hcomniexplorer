  ...
  return (
    <Container className="panel panel-inverse">
      ...
      <BodyContainer className="panel-body">
        ...
        <p>Please note:</p><ul><li>Registering a property with OmniExplorer.info costs a flat fee of 0.5 HC.</li><li>There is no registration expiry.</li></ul><p></p>
        ...
        <p></p><ul><li>Featuring a property with OmniExplorer.info costs a flat fee of 0.2 HC per month.</li><li>Properties must be registered to be eligible for inclusion in featured properties.</li></ul><p></p>
